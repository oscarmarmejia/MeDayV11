...
class FavoriteLast22 extends StatefulWidget {

  final User user;

  const FavoriteLast22({Key? key, required this.user}) : super(key: key);

  @override
  State<FavoriteLast22> createState() => _FavoriteLast2State();
}

class _FavoriteLast2State extends State<FavoriteLast22> {
 ...
 */
  Stream<QuerySnapshot> users = FirebaseFirestore.instance.collection('prueba1').snapshots();
